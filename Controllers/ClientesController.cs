...
using Facturacionn.Models;

namespace Facturacionn.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Nombre,Documento,Cuenta_contable,Estado")] Cliente cliente)
        {
